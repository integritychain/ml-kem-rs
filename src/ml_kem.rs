...
pub(crate) fn key_gen<const K: usize, const ETA1: usize, const ETA1_64: usize, const ETA1_256: usize>(
    ...
    let p1 = 384 * K;
    k_pke_key_gen::<K, ETA1, ETA1_64, ETA1_256>(ek, &mut dk[..p1]); // 3: ek ← ekPKE
...
>(
    ...
    for i in 0..K {
        ...
        assert_eq!(ek_tilde, ek[384 * i..384 * (i + 1)])
    }
...
>(
    ...
    assert_eq!(ct.len(), 32 * (DU * K + DV)); // Ciphertext type check
    assert_eq!(dk.len(), 768 * K + 96); // Decapsulation key type check
